...
public class WaitReceiveFragment extends BaseFragment implements Presenter.NotificationToActivity{
    ...
    protected void initView() {
        ...
        swipe_refresh_tool.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                presenter.getOrder(LoginManager.getInstance().getUserID(getActivity()), "WAITRECEIVE");
            }
        });
    }
