 ...
 * 功能：
 */
public class GoodsManagActivity extends BaseActivity implements View.OnClickListener,SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actiivty_goodsmanage);
        initView();
    ...
    private void initView() {
        loadTitle();
        mContext = this;
        uid = LoginManager.getInstance().getUserID(mContext);
    ...
    private void loadTitle() {
        setTitleString(getString(R.string.mine_shop_manager));
                ...
                public void onSuccess(ApiResponse apiResponse) {
                    if (apiResponse.getCode() == Api.SUCCESS) {
                     ...
                     //   adapter.notifyDataSetChanged();
                        ...
                        goodsContentBeans.clear();
                        ToastUtils.showShort(GoodsManagActivity.this, apiResponse.getMessage().toString());
                    }
                    adapter.notifyDataSetChanged();
                    dialog.dismiss();
                    swipeRefreshLayout.setRefreshing(false);
