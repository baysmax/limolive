...
/**
 * DTIconCircleImageView
 * 作者：李志超 on 2017/1/13 14:08
 */

public class DTIconCircleImageView extends ImageView {


    public DTIconCircleImageView(Context context) {
        super(context);
    }

    public DTIconCircleImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DTIconCircleImageView(Context context, AttributeSet attrs, int defStyle) {
