...
public class SxbLog {
    ...
    public static void standardEnterRoomLog(String TAG, String info, String success, String info2) {
        if (LiveMySelfInfo.getInstance().getIdStatus() == Constants.HOST) {
            SxbLog.d(TAG, LogConstants.ACTION_HOST_CREATE_ROOM + LogConstants.DIV + LiveMySelfInfo.getInstance().getId() + LogConstants.DIV + info
                    + LogConstants.DIV + success + LogConstants.DIV + info2);
        } else {
            SxbLog.d(TAG, LogConstants.ACTION_VIEWER_ENTER_ROOM + LogConstants.DIV + LiveMySelfInfo.getInstance().getId() + LogConstants.DIV + info +
                    LogConstants.DIV + success + LogConstants.DIV + info2);
        }
    }
    ...
    public static void standardQuiteRoomLog(String TAG, String info, String success, String info2) {
        if (LiveMySelfInfo.getInstance().getIdStatus() == Constants.HOST) {
            SxbLog.d(TAG, LogConstants.ACTION_HOST_QUIT_ROOM + LogConstants.DIV + LiveMySelfInfo.getInstance().getId() + LogConstants.DIV + info
                    + LogConstants.DIV + success + LogConstants.DIV + info2);
        } else {
            SxbLog.d(TAG, LogConstants.ACTION_VIEWER_QUIT_ROOM + LogConstants.DIV + LiveMySelfInfo.getInstance().getId() + LogConstants.DIV + info +
                    LogConstants.DIV + success + LogConstants.DIV + info2);
        }
    }
    ...
    public static void standardMemberShowLog(String TAG, String info, String success, String info2) {
            SxbLog.d(TAG, LogConstants.ACTION_VIEWER_UNSHOW + LogConstants.DIV + LiveMySelfInfo.getInstance().getId() + LogConstants.DIV + info
                    + LogConstants.DIV +success + LogConstants.DIV + info2);
    }
