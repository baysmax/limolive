...
import com.example.project.limolive.tencentim.ui.AddFriendActivity;
import com.example.project.limolive.tencentim.ui.ProfileActivity;
...
public class FriendProfile implements ProfileSummary {
    ...
    public String getGroupName(){
        if (profile.getFriendGroups().size() == 0){
            return LiveMallApplication.getContext().getString(R.string.default_group_name);
        }else{
