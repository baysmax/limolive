...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        LinearLayout linearLayout = new LinearLayout(LiveMallApplication.getContext());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.setGravity(Gravity.CENTER);
        ImageView voiceIcon = new ImageView(LiveMallApplication.getContext());
    ...
    public String getSummary() {
        return LiveMallApplication.getContext().getString(R.string.summary_voice);
    }
