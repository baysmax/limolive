...
public class PushUtil implements Observer {
    ...
    private void PushNotify(TIMMessage msg) {
        ...
        NotificationManager mNotificationManager = (NotificationManager) LiveMallApplication.getContext().getSystemService(LiveMallApplication.getContext().NOTIFICATION_SERVICE);
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(LiveMallApplication.getContext());

        //想要通知的话 在这里搞一下
       /* Intent notificationIntent = new Intent(LiveMallApplication.getContext(), HomeActivity.class);
        notificationIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP
                | Intent.FLAG_ACTIVITY_SINGLE_TOP);
        PendingIntent intent = PendingIntent.getActivity(LiveMallApplication.getContext(), 0,
...
//                .setNumber(++pushNum) //设置通知集合的数量
    ...
    public void reset() {
        NotificationManager notificationManager = (NotificationManager) LiveMallApplication.getContext().getSystemService(LiveMallApplication.getContext().NOTIFICATION_SERVICE);
