...
public class Constants {
    ...
    // 柠檬直播  老账号
   // public static final int SDK_APPID = 1400014339;
   // public static final int ACCOUNT_TYPE = 7279;

    // // 柠檬直播  新账号
       public static final int SDK_APPID = 1400026995;
       public static final int ACCOUNT_TYPE = 11395;
    ...
    public static final int MEMBER_PRAISE = 5;
    ...
    public static final int AVIMCMD_TEXT = -1;         // 普通的聊天消息 -1

    public static final int AVIMCMD_NONE = AVIMCMD_TEXT + 1;               // 无事件 0

    // 以下事件为TCAdapter内部处理的通用事件
    public static final int AVIMCMD_ENTERLIVE = AVIMCMD_NONE + 1;          // 用户加入直播,1
    public static final int AVIMCMD_EXITLIVE = AVIMCMD_ENTERLIVE + 1;         // 用户退出直播,2
    public static final int AVIMCMD_PRAISE = AVIMCMD_EXITLIVE + 1;           // 点赞消息,3
    public static final int AVIMCMD_HOST_LEAVE = AVIMCMD_PRAISE + 1;         // 主播离开,4
    public static final int AVIMCMD_HOST_BACK = AVIMCMD_HOST_LEAVE + 1;      // 主播回来,5
    public static final int     PRESENT_MSG = 12;//礼物消息 12
