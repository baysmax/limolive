package com.example.project.limolive.localalbum.ui;
...
import com.example.project.limolive.localalbum.common.ExtraKey;
...
import com.example.project.limolive.localalbum.common.StringUtils;
            ...
            switch (requestCode) {
                case ImageUtils.REQUEST_CODE_GETIMAGE_BYCAMERA:
                    ...
                    if (file.exists()) {
                        ...
                        localFile.setFilePath(uri.getPath());
    ...
    public class FolderAdapter extends BaseAdapter {
        ...
        FolderAdapter(Context context, Map<String, List<LocalImageHelper.LocalFile>> folders) {
            ...
            options = new DisplayImageOptions.Builder()
                    ...
                    .setImageSize(new ImageSize(((LiveMallApplication) context.getApplicationContext()).getQuarterWidth(), 0))
        ...
        public View getView(int i, View convertView, ViewGroup viewGroup) {
            ...
            if (files.size() > 0) {
                ImageLoader.getInstance().displayImage(files.get(0).getThumbnailUri(), new ImageViewAware(viewHolder.imageView), options,null, null, files.get(0).getOrientation());
            }
            return convertView;
        }
