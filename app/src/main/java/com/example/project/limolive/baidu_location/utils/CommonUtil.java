package com.example.project.limolive.baidu_location.utils;
...
//        defualt_map_size_icon
        if (bitmapSize == null) {
            Bitmap var2 = BitmapFactory.decodeResource(LiveMallApplication.getApplication().getResources(), R.mipmap.icon_ditu);
    ...
    public static Map<String, String> inputMapForUrl(SearchModel searchModel, int index, int pageSize) {
        ...
        map.put("uid", searchModel.getUid());
        map.put("latitude", String.valueOf(searchModel.getLatitude()));
        map.put("longitude", String.valueOf(searchModel.getLongitude()));
        map.put("page", String.valueOf(index));
//        //ak
//        map.put("ak", LiveMallApplication.AK());
//
//        //表名
