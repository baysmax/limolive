...
import com.example.project.limolive.tencentim.adapters.ExpandGroupListAdapter;
...
public class ContactFragment extends BaseFragment implements  View.OnClickListener, Observer {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null){
            ...
            LiveMallTitleBar title = (LiveMallTitleBar) view.findViewById(R.id.title_bar_standard);
    ...
    private void showMoveDialog() {
        ...
        addFriend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {   //添加好友
