...
public class OrderPresenters extends Presenter {

    private List<OrderBean> list;
    private ListView listView;
    private OrderAdapters adapter;
    private String type;
    public OrderPresenters(Context context) {
        super(context);
    }
    ...
    public void getOrder(String user_id,String type){
        this.type=type;
        Api.myOrder_order(user_id,type, new ApiResponseHandler(context) {
            @Override
    ...
    public void setAdapter(ListView listView){
        ...
        list = new ArrayList<>();
        if(adapter ==null){
            adapter = new OrderAdapters(context,list,type);
