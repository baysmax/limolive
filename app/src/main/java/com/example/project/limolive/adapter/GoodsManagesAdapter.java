 ...
 * 功能：
 */
public class GoodsManagesAdapter extends BaseAdapter {
    private Context context;
    //GoodsContentBean
    private List<GoodInfoBean> goodsContentBeans;

    public GoodsManagesAdapter(Context context, List<GoodInfoBean> goodsContentBeans) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.rls = (RelativeLayout) convertView.findViewById(R.id.rls);//库存数量
        ...
        if (goodsContentBeans.get(position) != null) {
            ...
            viewHolder.rls.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    context.startActivity(new Intent(
                            ...
                            .putExtra("goods_id",goodsContentBeans.get(position).getGoods_id()));
                }
            });
        }
